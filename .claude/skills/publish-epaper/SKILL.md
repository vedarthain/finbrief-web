...
```json
{
  ...
  "ipoListings": [
    { "company_name": "...", "ticker": null, "exchange": "...", "issue_price_low": 0, "issue_price_high": 0,
      ...
      "fresh_issue": null, "offer_for_sale": null }
  ]
}
```
